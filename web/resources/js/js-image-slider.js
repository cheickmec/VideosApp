...
function mcImgSlider(i) {
    ...
    }, P = document, J = window.requestAnimationFrame, V = window.cancelAnimationFrame, nb = ["ms", "webkit"], v = "", db = 0; db < nb[d] && !J; ++db) {
        v = nb[db];
    ...
    var c = "style", H = "display", Eb = "visibility", r = "width", q = "height", O = "top", B = "background", p = "undefined", Fb = "marginLeft", F = "appendChild", l = "parentNode", k = "nodeName", S = "innerHTML", bb = "offsetWidth", u = setTimeout, z = clearTimeout, w = "indexOf", N = "setAttribute", ab = "removeChild", L = function () {
        ...
        if (a[w]("Opera") != -1)
            b = 400;
        return b
    }, T = zb() < 9, Z = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), K = function (a, b) {
        if (a) {
            a.o = b;
            if (T)
    ...
    L.prototype = {k: {c: i.transitionTime, a: function () {}, b: L.a.f, d: 1}, m: function (h, d, g, c) {
    ...
    var G = new L, fb = function () {
        ...
        return a.join("")
    }, b = {a: 0, e: "", d: 0, c: 0, b: 0}, a, f, o, s, D, A, m, R, x, M, W, e, E, j = null, vb = function () {
        ...
        a = {b: i.pauseTime, c: i.transitionTime, f: i.slices, g: i.boxes, d: i.license, h: i.hoverPause, i: i.autoAdvance, l: i.thumbnailsWrapperId, Ob: function () {
    ...
    kb.prototype = {c: function () {
            ...
            var g = {b: L.a.j, c: a.c * 1.6, a: function () {
                    j.o()
                }};
            ...
            for (var p = {c: a.c / 1.3}, j = 0, n = a.g * 2; j < n; j++) {
                for (var h = j, k = 0; k < a.m; k++) {
                    if (h >= 0 && h < a.g) {
                        var l = f[k][h];
                        cb(p, b[d], o, l, {width: 0, height: 0, opacity: 0}, {width: l.w, height: l.h, opacity: 1}, m);
                        o++
                    }
                    h--
                }
